+++
path = "xenoblade"
title = "Xenoblade research"
template = "xenoblade.html"
+++
...
* **Recordkeeper**, a save editor for Xenoblade 3 and Future Redeemed.
    * Source: [GitHub](https://github.com/RoccoDev/recordkeeper)
    * Webapp: [Recordkeeper](https://rocco.dev/recordkeeper)
...
* **Xenoblade 3 file loader**, to allow loading external files.
    * Source/Download: [GitHub](https://github.com/RoccoDev/xc3-file-loader)
    * License: GPL-3.0
* **Xenoblade 3 difficulty editor**, to access the Very Hard difficulty and custom settings.
    * Source/Download: [GitHub](https://github.com/RoccoDev/xc3-difficulty-unlocker)
    * License: GPL-3.0
* **ImGui backend for Xenoblade games**, based on [CraftyBoss](https://github.com/CraftyBoss)'s NVN backend.
    * Source: [GitHub](https://github.com/RoccoDev/imgui-xeno)
    * License: GPL-2.0
