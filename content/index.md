...
title = "Hi, I'm Rocco."
+++
I'm a programmer from **🇮🇹 Italy**.  I use [Rust](https://rust-lang.org) (and you should too) for most of my projects,
but I also have a deep knowledge of Java for my client and server mods.
...
### Tech I work with:
* Minecraft server software (Paper, Velocity)
* Databases (Redis, PostgreSQL, MongoDB)
* Containers (Docker, Kubernetes)
* Web frameworks: backend (Actix Web, Jetty, Next.js), frontend (React)
* Reverse proxies (NGINX, HAProxy)
* ARM systems (Nintendo Switch, Raspberry Pi)
