+++
title = "Xenoblade 3: Hero appearances in the final fight"
...
As a side note, in the X∞ and Y∞ fights the hero you have in your party will choose the side representing their faction. This is not the case for Ino and Segiri, who will always join the
X∞ team. Furthermore, Riku/Manana, Monica, Triton, Ghondor, and Gray don't follow this, instead choosing the side with the least members of their role (essentially the side with the least Tanks for Monica, and least Attackers for everyone else), choosing randomly if tied.
...
First, it counts the party members for each role. It searches for the role with the least members, following this order in case of a tie: Healer > Tank > Attacker. 
Then, it tries to get a *random* Hero with that role in the "ascended" group. If it can't find one, it repeats the process with the other hero group.
